...
console.log(color('  🦄NixiSystemV2.1. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/5493704583368'))
    console.log(color('🐶', 'cyan'), color('Nixi Bot Is Online...', 'pink'))
    console.log(color('🐶', 'cyan'), color('Welcome Max! Hope You Doing Well~', 'magenta'))
    console.log(color('🐶','red'), color('Thanks For Using NixiSystem (beta)', 'white'))
